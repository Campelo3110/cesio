...
async function gerarPerguntaHandler(req, res, body) {
    ...
    for (let i = 0; i < numPerguntas; i++) {
        const promptText = `Pegue perguntas de vestibular/enem no começo da pergunta especifique de que vestibular é aquela pergunta(sem ser repetidas) sobre o tema ${tema} com dificuldade ${dificuldade}, 4 alternativas de resposta, e uma explicação da correta. Retorne no formato JSON com a seguinte estrutura (não é necessário especificar que o arquivo está em JSON):
        {
          "question": "Pergunta",
          "answers": [
